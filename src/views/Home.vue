...
<template>
  <main class="relative top-12 block lg:top-16">
    <section class="mt-4 px-5">
      ...
      >
        <h1
          class="fadeIn grHeading max-w-lg text-left text-5xl font-bold sm:text-center sm:text-6xl md:max-w-3xl md:text-7xl lg:max-w-4xl lg:text-8xl xl:max-w-5xl xl:text-8xl"
        >
          Not making.<br />
          We're creating.
        </h1>
        ...
        >
          ...
          out to build something, we want to create a sound that is unique and
    ...
    <section class="relative mt-8">
      ...
      >
        <div class="cart3 col-span-2 h-128 rounded-lg md:col-span-1"></div>
        <div class="cart3 col-span-2 h-128 rounded-lg md:col-span-1"></div>
        <div class="cart3 col-span-2 h-128 rounded-lg"></div>
      </div>
    </section>
  </main>
</template>
